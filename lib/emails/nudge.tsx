...
export function NudgeEmail({ mentorName, mentorProfileId }: Props) {
  const profileUrl = `${baseUrl}/dashboard/mentors/${mentorProfileId}`;

  return (
    <Html>
      <Head />
      <Preview>{mentorName} wants to hear from you</Preview>
      <Body style={main}>
        <Container style={container}>
          <Heading style={heading}>Book a session</Heading>
          <Text style={text}>
            {mentorName} would love to connect with you. Book a session to continue your mentorship journey.
          </Text>
